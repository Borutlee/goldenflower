...
const formatProduct = (row) => ({
    ...
    legacy_id: row.legacy_id,   // 🔧 FIX: نضيفها صريحة كمان عشان أي كومبوننت بيدور على legacy_id مباشرة (زي ProductCard/SingleProduct) يلاقيها
    ...
    image: row.image,
    images: row.images || [],    // 🔧 FIX: كانت ناقصة تمامًا! من غيرها SingleProduct مش بيقدر يعرض أكتر من صورة أبدًا
