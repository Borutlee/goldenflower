...
import { FiEdit2, FiSave, FiX, FiShoppingBag, FiHeart, FiUser, FiMail, FiCamera, FiLogOut } from 'react-icons/fi';
...
export default function Profile() {
    ...
    const { user } = useAuth(); // ← بيانات اليوزر من Supabase
    ...
    const userName = user?.user_metadata?.name || 'Golden Member';
